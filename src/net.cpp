...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "JaegerNote " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"JaegerNotetools.com", "dnsseed.JaegerNotetools.com"},
    {"JaegerNotepool.org", "dnsseed.JaegerNotepool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"JaegerNotetools.com", "testnet-seed.JaegerNotetools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. JaegerNote is probably already running."), addrBind.ToString().c_str());
        else
